...
const DECISION_SKILLS: ReadonlyArray<DecisionSkillDescription> = Object.freeze([
  ...
  { name: 'acquire_resource', description: 'Acquire at least a bounded quantity of one resource through visible search, known resource memory, no-dig exploration, bounded excavation, and deterministic gathering.' },
